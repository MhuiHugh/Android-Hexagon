...
public class ImageLoaderV4 implements IImageLoaderClient {
    ...
    public void displayImage(Context context, String url, ImageView imageView, int holderRes, int errorRes, IImageLoaderListener listener, boolean cacheInMemory) {
        if (client != null) {
            client.displayImage(context, url, imageView, holderRes,errorRes, listener,cacheInMemory);
        }
    }
    ...
    public void downLoadImage(Context context, String url, IImageLoaderListener listener) {
        if(client!=null){
            client.downLoadImage(context,url,listener);
        }
    }
    ...
    public boolean hasImageCacheUrl(Context context, String url) {
        if(client!=null){
           return client.hasImageCacheUrl(context,url);
        }else{
            return false;
        }
    }
    ...
    public boolean hasImageCacheUrlSync(Context context, String url) {
        if(client!=null){
            return client.hasImageCacheUrlSync(context,url);
        }else{
            return false;
        }
    }
